                ...
                <dd className="m-list01-listText">
                  <ol className="m-list01-listBLock02">
                    <li className="m-list01-listText02">
                      ...
                      <br />
                      ただし、個人情報保護法第16条第3項各号に該当する場合は、
                      あらかじめ特定し公表した利用目的の達成に必要な範囲を超えてユーザーの個人情報を取り扱うことがあります。
                      <ul className="m-list01-listBLock03">
                        <li className="m-list01-listText02">
                        ...
                        <li className="m-list01-listText02">
                          c.広告表示：本サイトでは、Googleを含む第三者の広告配信事業者がCookieを使用して、
                          ユーザーのウェブサイトでの閲覧履歴に基づく広告を配信します。
                          <br />
                ...
                <dd className="m-list01-listText">
                  <ol className="m-list01-listBLock02">
                    <li className="m-list01-listText02">
                      ...
                      <br />
                      禁止事項に違反した場合には、アクセス禁止措置、投稿禁止措置、コメント等の情報の全部もしくは一部の削除、
                      又は公開範囲の変更等の不利益な措置を採ることがあります。
                      <ul className="m-list01-listBLock03">
                        <li className="m-list01-listText02">
                        ...
                        <li className="m-list01-listText02">
                          s.本サイト又は他者のサーバーに負担をかける行為、
                          もしくは、本サービスの運営やネットワーク・システムに支障を与える行為、又はこれらのおそれのある行為。
                        </li>
                        <li className="m-list01-listText02">
                ...
                <dd className="m-list01-listText">
                  <ol className="m-list01-listBLock02">
                    <li className="m-list01-listText02">
                      ...
                      <br />
                      万一、第三者との間で何らかの紛争が発生した場合には、当該ユーザーの費用と責任において問題を解決するとともに、
                      本サイトに何等の迷惑又は損害を与えないものとします。
                    </li>
                  </ol>
                </dd>
                <dt className="m-list01-listTitle">
